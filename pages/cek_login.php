...
$login=mysql_query("SELECT * FROM users WHERE username='$username' AND password='$pass' and user_aktif='Y' ");
$ketemu=mysql_num_rows($login);
$r=mysql_fetch_array($login);
$login2=mysql_query("SELECT * FROM users WHERE username='$username' AND password='$pass' and user_aktif='N'");
