...
<div class='box-header'>
  <h3 class='box-title'>Riwayat Pengajuan KIS</h3> <br> <br>
...
<div class='box-body'>
  <table id='example1' class='table table-bordered table-striped'>
    ...
    elseif ($_SESSION['leveluser']=='penduduk'){
      $tampil = mysql_query("SELECT * FROM `pengajuan_kis`
                          INNER JOIN `penduduk` ON `pengajuan_kis`.`id_penduduk` = `penduduk`.`id_penduduk`
                          WHERE status='Selesai' AND id_penduduk='$_SESSION[id_penduduk]' ORDER BY id_pengajuan DESC");
    }
...
echo"
<form  role='form' method='POST' action='$aksi?module=PengajuanKIS&act=input' enctype='multipapenduduk/form-data'>
