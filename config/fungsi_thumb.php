...
function UploadKelahiran($fupload_name){
  //direktori banner
  $vdir_upload = "../upload/file_kelahiran/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
function UploadPBB($fupload_name){
  //direktori banner
  $vdir_upload = "../upload/pbb/";
  $vfile_upload = $vdir_upload . $fupload_name;
...
function UploadStrukListrik($fupload_name){
  //direktori banner
  $vdir_upload = "../upload/struk_listrik/";
  $vfile_upload = $vdir_upload . $fupload_name;
